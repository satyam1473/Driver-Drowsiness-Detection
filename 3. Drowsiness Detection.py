...
# Set camera resolution to 480x480
...
while True:
    ...
    for face in faces:
        ...
        if Eye_Rat < 0.25:
            ...
            cv2.putText(frame, "Alert!!!! FOCUS PLEASE", (50, 450),
                        cv2.FONT_HERSHEY_PLAIN, 2, (25, 56, 210), 3)

            # CALLING THE AUDIO FUNCTION OF TEXT TO 
            # AUDIO FOR ALERTING THE PERSON
            engine.say("Alert!!!! Focus Please")
            playsound("C:/Users/SATYAM KUMAR/Desktop/beep-01a.mp3")
            engine.runAndWait()
